...
Ships three generated backgrounds plus a photo, the **Hawaii-Sunset** icon theme
(Yaru's folder family repainted with the sunset gradient), and a themed unlock
banner.
...
| `backgrounds/` | Three generated backgrounds plus `Hawaiian Beach.png`. |
...
| `src/` | Sources the backgrounds and icons are generated from. |

## Rebuilding

The committed backgrounds and icons are generated output; `src/` holds what
produced them. Re-render only if you change a source.
